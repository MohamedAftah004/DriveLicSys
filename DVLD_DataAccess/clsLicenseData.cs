...
namespace DVLD_DataAccess
{
    public class clsLicenseData
    {
        ...
        public static bool FindOrdinaryClassLicenseInfoByID(int LicenseID, ref int ApplicationID, ref int DriverID, ref int LicenseClass, ref DateTime IssueDate, ref DateTime ExpirationDate, ref string Notes, ref decimal PaidFees, ref bool IsActive, ref byte IssueReason, ref int CreatedByUserID)
        {
            bool isFound = false;

            SqlConnection connection = new SqlConnection(clsDataAccessSettings.ConnectionString);
            string query = "SELECT * FROM Licenses WHERE LicenseID = @LicenseID and LicenseClass = 3 and IsActive = 1";
            SqlCommand command = new SqlCommand(query, connection);
            command.Parameters.AddWithValue("@LicenseID", LicenseID);
	...
	CreatedByUserID = @CreatedByUserID	WHERE LicenseID = @LicenseID";
        ...
        public static bool IsLicenseExpiared(int LicenseID )
        {
