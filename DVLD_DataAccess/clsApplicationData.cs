...
namespace DVLD_DataAccess
{
    public class clsApplicationData
    {
        ...
        public static DataTable Get_Clearly_AllInternationalApplications()
        {
        ...
        public static bool IsApplicationExist(int PersonID , int LicenseClassID)
        {
            ...
            string query = @"SELECT Found=1 FROM NonRepetedApplication_View WHERE
                                    ApplicantPersonID = @PersonID and LicenseClassID = @LicenseClassID and
