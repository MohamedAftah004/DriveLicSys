...
namespace DVLD.Applications
{
    ...
    public partial class frmAddUpdateLocalDrivingLicesnseApplication: Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (clsApplication.IsApplicationExist(_SelectedPersonID, LicenseClassID))
            {
                MessageBox.Show("Choose another License Class, the selected Person Already have an active application for the selected license class." , "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
